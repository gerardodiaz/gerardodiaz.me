...
function widget_mySearch() {
    // print some HTML for the widget to display here
	echo "<form role='search' method='get' id='searchform' action='/' > 
	<div><input type='search' value='' name='s' id='s' class='mysearch' placeholder='Search...' /> 
...
wp_register_sidebar_widget(
    'mySearch',        // your unique widget id
    'My Custom Search',          // widget name
    'widget_mySearch',  // callback function
    array(                  // options
        'description' => 'My customized search widget.'
    )
);



function widget_followMe() {
    // print some HTML for the widget to display here
	echo "<section id='w-followme'>
				<header>
					<h1>Follow Me</h1>
				</header>
				<ul class='social'>
					<li id='twitter'><a class='twitter' href='http://twitter.com/#!/gerardodm'></a></li>
					<li id='dribbble'><a class='dribbble' href='http://dribbble.com/gerardodiaz'></a></li>
					<li id='linkedin'><a class='linkedin' href='http://www.linkedin.com/in/gerardodm'></a></li>
					<li id='rss-feed'><a class='rss-feed' href='/category/blog/rss'></a></li>
				</ul>
...
wp_register_sidebar_widget(
    'followme',        // your unique widget id
    'Follow Me',          // widget name
    'widget_followMe',  // callback function
    array(                  // options
        'description' => 'Social Icons to follow me.'
    )
);
...
function widget_qrcode() {
    // print some HTML for the widget to display here
	echo "<!--<section id='w-qrcode'>
				<header>
					<h1>My Card</h1>
				</header>
				<img src='/wp-content/themes/gerardodiaz/img/qrcode.png' alt='QR Code' />
			</section>-->";
}

wp_register_sidebar_widget(
    'qrcode',        // your unique widget id
    'QR Code',          // widget name
    'widget_qrcode',  // callback function
    array(                  // options
        'description' => 'QR Image to download my BizCard.'
    )
);
...
function widget_lasttweet() {
    // print some HTML for the widget to display here
	echo "<section id='w-lasttweet'>
				<header>
					<h1>Last Tweet</h1>
				</header>
				<div id='tweetblock'>
...
wp_register_sidebar_widget(
    'lasttweet',        // your unique widget id
    'Last Tweet',          // widget name
    'widget_lasttweet',  // callback function
    array(                  // options
        'description' => 'Display of my last Tweet from @gerardodm.'
    )
);
...
function widget_otherlinks() {
    // print some HTML for the widget to display here
	echo "<section id='w-otherlinks'>
				<header>
					<h1>Other Links</h1>
				</header>
				<ul class='links'>
...
wp_register_sidebar_widget(
    'otherlinks',        // your unique widget id
    'Other Links',          // widget name
    'widget_otherlinks',  // callback function
    array(                  // options
        'description' => 'List of more links within my site.'
    )
);


/* CONFERENCES FROM LANYRD ------------------------ */

function widget_conferences() {
    // print some HTML for the widget to display here
	echo "<section id='w-conferences'>
				<header>
					<h1>Conferences</h1>
				</header>
				<div class='lanyrd-target-splat'>
					<a href='http://lanyrd.com/profile/gerardodm/' class='lanyrd-splat lanyrd-number-1' rel='me'></a>
				</div>
					
				<div class='lanyrd-target-splat'>
					<a href='http://lanyrd.com/profile/gerardodm/' class='lanyrd-splat lanyrd-number-1 lanyrd-context-future lanyrd-type-tracking' rel='me'>My conferences on Lanyrd</a>
				</div>
			</section>";
}

wp_register_sidebar_widget(
    'conferences',        // your unique widget id
    'Lanyrd Conferences',          // widget name
    'widget_conferences',  // callback function
    array(                  // options
        'description' => 'Display of confereces I will be attending via Lanyrd'
    )
);
